    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_event', models.DateTimeField(default=datetime.datetime(2023, 1, 12, 22, 6, 8, 633035, tzinfo=datetime.timezone.utc), validators=[products.validators.validate_datetime_no_past])),
