    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_event', models.DateTimeField(default=datetime.datetime(2023, 1, 31, 10, 48, 44, 631242, tzinfo=datetime.timezone.utc), validators=[products.validators.validate_datetime_no_past])),
