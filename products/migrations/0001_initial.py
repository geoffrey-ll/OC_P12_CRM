    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_number', models.PositiveSmallIntegerField(default=1, unique=True, validators=[products.validators.validate_contract_number_format])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_event', models.DateTimeField(default=datetime.datetime(2022, 12, 26, 10, 51, 44, 183003, tzinfo=datetime.timezone.utc), validators=[products.validators.validate_datetime_no_past])),
                ...
                ('support_employee', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='persons.supportteamemployee')),
            ],
        ),
    ]
